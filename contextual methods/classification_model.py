...
class ClassificationModel:
    def __init__(
        ...
        Args:
            model_type: The type of model (bert, xlnet)
    ...
    def train(
        ...
        **kwargs,
        ...
        # # freeze all encoding layers + classifier and set requires_grad to False
        ...
        #
        # # unfreeze from initialized layer .. - till 12
        # for i in range(unfreeze, 12):
        #     for param in list(model.bert.encoder.layer[i].parameters()):
        #         param.requires_grad = True
        #         print("Unfrozen Layer: ", unfreeze)
        #
        # # unfreeze specific layer
        # for param in list(model.bert.encoder.layer[unfreeze].parameters()):
        #     param.requires_grad = True
        # print("unfroze Layer: ", unfreeze)
        ...
        for _ in train_iterator:
            for step, batch in enumerate(tqdm(train_dataloader, desc="Current iteration", disable=args["silent"])):
                ...
                # write running loss to text file
                # with open("runningloss.txt", "a") as output:
                #     output.write(str(current_loss))
                #     output.write("\n")
    ...
    def compute_metrics(self, preds, labels, eval_examples, multi_label=False, **kwargs):
        ...
        if self.model.num_labels == 2:
            ...
            return {**{"mcc": mcc,"f1": f1,"prec": precision,"recall": recall, "acc": accuracy}, **extra_metrics}, wrong
